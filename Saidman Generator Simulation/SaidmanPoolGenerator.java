...
public class SaidmanPoolGenerator extends PoolGenerator {
	...
	protected double Pr_SPOUSAL_DONOR = 0.4897;
        ...
        //Original SaidmanPoolGenerator
	/*protected double Pr_LOW_PRA = 0.7019;
	  protected double Pr_MED_PRA = 0.2;*/

        // UNOS Probabilities 
        protected double Pr_LOW_PRA = 0.216;
        protected double Pr_MED_PRA = 0.16;
	...
	protected double Pr_PATIENT_TYPE_O = 0.651;
	protected double Pr_PATIENT_TYPE_A = 0.200;
	protected double Pr_PATIENT_TYPE_B = 0.124;

        protected double Pr_DONOR_TYPE_O = 0.345;
	protected double Pr_DONOR_TYPE_A = 0.459;
        protected double Pr_DONOR_TYPE_B = 0.197; 
